...
delta_tag = "delta"
blobs_tag = "blobs"
calibrate_button_tag = "calibrate"
orchestrate_button_tag = "orchestrate"
...
def init_gui(vid, test, texture_data, switch_output, start_calibrate_thread, capture_brightness_multiplier, start_orchestrate_thread):
    dpg.create_context()
